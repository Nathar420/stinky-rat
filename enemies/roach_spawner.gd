...
func _process(delta: float) -> void:
	...
	if time_elapsed - last_increase_time >= spawn_increase_interval:
		...
		print("Roach spawn difficulty increased! Now spawning ", enemies_per_spawn, " roaches at once")
...
func _spawn_enemies() -> void:
	if enemy_scene == null:
		push_error("RoachSpawner: No enemy scene assigned!")
		return
